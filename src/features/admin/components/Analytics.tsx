...
export function Analytics() {
    const { data: websiteAnalytics, isLoading: isLoadingWebsites } = useWebsiteAnalytics();
    ...
    const { totalWebsites, websitesByCategory, websitesByStatus, newWebsites } = websiteAnalytics.data;
